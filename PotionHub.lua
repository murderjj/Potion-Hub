loadstring(game:HttpGet("https://raw.githubusercontent.com/murderjj/Potion-Hub/main/Encrypt.lua"))("Encrypt")
loadstring(game:HttpGet("https://raw.githubusercontent.com/murderjj/Potion-Hub/main/Encrypt1.lua"))("Arabic String")
...
local UI = game:GetObjects("rbxassetid://7947905579")[1]
...
if not isfile("Potion-Hub/Presets/Default.preset") then
...
function ChangeLog(aFeature1, aFeature2, aFixes1, aFixes2)
	local Gui = game:GetObjects("rbxassetid://7947954630")[1]
	...
	if aFixes2 then
		Fixes2["Visible"] = true
		Fixes2["Text"] = "    Fixed up the UI and added a discord invite\n    "
	end
...
Input.FocusLost:connect(function(Enter)
	if Enter then
		...
		ID = "nil\n?\n " .. Header .. "        [\"Potion Hub | discord.gg/bRe8JjQC4c\"]" .. ID
		if not BackPlay then
...
presetButton.MouseButton1Down:connect(function()
	if game.CoreGui:FindFirstChild("Preset") then
		...
		wait(.5)
		loadstring(game:HttpGet("https://raw.githubusercontent.com/murderjj/Potion-Hub/main/PresetMakerSource.lua"))()
	else
		loadstring(game:HttpGet("https://raw.githubusercontent.com/murderjj/Potion-Hub/main/PresetMakerSource.lua"))()
	end
end)
